      ...
      <div className="flex flex-col gap-5 w-[95%] md:w-[90%] lg:w-[80%] mx-auto">
        ...
        <div className="flex flex-col gap-6">
          <p className="text-gray-500 text-[12px] md:text-[14px] lg:text-[17px] leading-8  ">
            گروه ویکی طوری با سابقه  ایجاد و ویرایش بیش از 200 مقاله و ثبت 20
            هزار ویرایش در ویکی پدیا فارسی، انگلیسی و عربی دانش و تجربه و تخصص
            خود را در اختیار شما قرار می دهد. برای داشتن مقاله در ویکی پدیا همین
            حالا با ما تماس بگیرید و از مشاوره رایگان ما بهره مند شوید. با
            ویکی طوری، صفحه اول گوگل از آن شماست.
          </p>
        </div>
      </div>
    </div>
