    ...
    <div className="w-full min-h-[400px]">
      ...
      <div className="flex flex-col items-center justify-center gap-6 mt-[110px] ">
        ...
        <p className="text-[14px] sm:text-md  md:text-lg lg:text-[18px] 2xl:text-[26px] leading-5 lg:leading-8 text-gray-400 z-40 max-w-[85%] md:max-w-[55%] lg:max-w-[45%] text-center tracking-wider">
          تیم ویکی طوری با سابقه ایجاد و ویرایش بیش از   <span className="text-extrabold text-white">200 مقاله </span><span className="text-extrabold text-white">  و ثبت 20 </span>          هزار ویرایش در ویکی پدیا فارسی، انگلیسی و عربی دانش و تجربه و تخـــصص
        </p>
        <DownloadButton />
      </div>
    </div>
